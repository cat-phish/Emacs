...
(use-package general
        ...
        ;; "n" '(my/toggle-relative-line-numbers :wk "Toggle relative/absolute line numbers")
    	  ...
    	  (start/leader-keys
            ...
            "o f t" '(my/org-cycle-todo-entries :wk "cycle todo")
            "o f a" '(my/org-cycle-all-entries  :wk "cycle all")
                        ...
                        ((agenda ""
                         ...
                         (todo "TODO"
                               ((org-agenda-overriding-header "📦 Backlog")
								...
								(defun my/org-cycle-all-entries ()
                                   "Cycle visibility for every heading in the file."
                                   (interactive)
                                   (org-map-entries
                                   (lambda ()
                                   (if (outline-invisible-p (line-end-position))
