...
(with-eval-after-load 'org-agenda
  ...
  (evil-define-key 'motion org-agenda-mode-map
    ...
    ;; ;; Org-agenda commands (with 'o' prefix)
    ;; (kbd "ot") 'org-agenda-todo
    ;; (kbd "os") 'org-agenda-schedule
    ;; (kbd "od") 'org-agenda-deadline
    ;; (kbd "or") 'org-agenda-redo
    ;; (kbd "oa") 'org-agenda-archive
    ;; (kbd "oA") 'org-agenda-archive-default
    ;; (kbd "oT") 'org-agenda-set-tags
    ;; (kbd "op") 'org-agenda-priority
    ;; (kbd "oi") 'org-agenda-clock-in
    ;; (kbd "oO") 'org-agenda-clock-out
    ;; (kbd "oC") 'org-agenda-clock-cancel
    ;; (kbd "oR") 'org-agenda-refile
    ;; (kbd "ow") 'org-agenda-week-view
    ;; (kbd "oy") 'org-agenda-year-view
    ;; (kbd "om") 'org-agenda-month-view
    ;; (kbd "ov") 'org-agenda-view-mode-dispatch
    ;; (kbd "of") 'org-agenda-filter
    ;; (kbd "o/") 'org-agenda-filter
    ;; (kbd "oF") 'org-agenda-follow-mode
    ;; (kbd "ol") 'org-agenda-log-mode
    ;; (kbd "oc") 'org-agenda-goto-calendar
    ;; (kbd "oD") 'org-agenda-toggle-diary
    ;; (kbd "og") 'org-agenda-toggle-time-grid
    ;; (kbd "oe") 'org-agenda-set-effort
    ;; (kbd "o:") 'org-agenda-set-tags
    ;; (kbd "on") 'org-agenda-add-note
    ;; (kbd "ok") 'org-agenda-kill
    ;; (kbd "ou") 'org-agenda-undo
    ;; (kbd "ox") 'org-agenda-exit
    ;; (kbd "oq") 'org-agenda-quit
    ;; (kbd "o.") 'org-agenda-goto-today
    ;; (kbd "oj") 'org-agenda-goto-date
	))
