...
(use-package evil-collection
  ...
  (with-eval-after-load 'org
    (evil-define-key 'normal org-mode-map
      (kbd "gh") 'org-up-element                  ;; Go to parent heading
      (kbd "gl") 'org-down-element                ;; Go to first child heading
      (kbd "gj") 'org-forward-heading-same-level  ;; Next heading at same level
      (kbd "gk") 'org-backward-heading-same-level ;; Prev heading at same level
      ))
