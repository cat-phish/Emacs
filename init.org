...
(use-package org-caldav
  ...
  ;; --- NEW SETTINGS: Export TODOs as Calendar Events ---
  ;; Force deadlines to show up as calendar events
  (setq org-icalendar-use-deadline '(event-if-todo event-if-not-todo))
  ;; Force scheduled dates to show up as calendar events
  (setq org-icalendar-use-scheduled '(event-if-todo event-if-not-todo))
  ;; Disable exporting them as hidden VTODO tasks
