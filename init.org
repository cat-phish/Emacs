...
#+PROPERTY: header-args:emacs-lisp :tangle ./init.el :mkdirp yes :exports none
#+Startup: overview nologdone nologrepeat noagenda
...
- [[#appearance][Appearance]]
    ...
    - [[#dashboard][Dashboard]]
- [[#dwim-helper-functions][DWIM Helper Functions]]
    - [[#lineheading-manipulation][Line/Heading Manipulation]]
    - [[#smart-delete-lineheading-with-contents][Smart Delete Line/Heading with Contents]]
    - [[#headinglist-insertion][Heading/List Insertion]]
    - [[#smart-ret-key][Smart RET Key]]
    - [[#yank-entire-subtree][Yank Entire Subtree]]
    - [[#auto-save-org-buffers-with-filter][Auto-Save Org Buffers (with filter)]]
    - [[#auto-format-src-blocks][Auto-Format Src Blocks]]
    - [[#refile-fixes][Refile Fixes]]
    - [[#cyclingtoggling-todo-and-done-states][Cycling/Toggling TODO and Done States]]
    - [[#collapse-done-entries-on-file-open][Collapse DONE Entries on File Open]]
    - [[#hide-properties-drawers][Hide Properties Drawers]]
    - [[#trigger-syncthing-sync-on-save][Trigger Syncthing Sync on Save]]
- [[#org-mode][Org Mode]]
...
- [[#development][Development]]
    ...
    - [[#yasnippet][Yasnippet]]
    - [[#tree-sitter-tect-objects][Tree-Sitter (Tect Objects)]]
...
- [[#utilities][Utilities]]
    ...
    - [[#rainbow-mode-show-colors-fixme][Rainbow-Mode (Show Colors) FIXME:]]
    - [[#pdf-tools][PDF Tools]]
    ...
    - [[#helpful][Helpful]]
    - [[#diminish-hide-modes-in-modeline][Diminish (Hide Modes in Modeline)]]
    - [[#rainbow-delimiters-parenthesis-colors][Rainbow Delimiters (Parenthesis Colors)]]
    - [[#which-key][Which-Key]]
    - [[#ws-butler-remove-whitespace][Ws-butler (Remove Whitespace)]]
...
the excellent [[https://github.com/MiniApollo/kickstart.emacs][Kickstart.emacs]] project by MiniApollo.
...
The goal for this config was to mirror my personal [[https://github.com/cat-phish/Neovim][Neovim config]] as
...
This config is heavily inspired by [[https://github.com/doomemacs/doomemacs][Doom Emacs]]. However, for my use case,
...
To learn more about why something like [[https://github.com/doomemacs/doomemacs/blob/master/docs/faq.org#why-does-doom-use-straightel-and-not-packageel][Doom Emacs]] uses straight.el not package.el.
