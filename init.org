...
- [[#dwim-helper-functions][DWIM Helper Functions]]
    ...
    - [[#copy-inside-code-blocks][Copy Inside Code Blocks]]
- [[#org-mode][Org Mode]]
    ...
    - [[#org-ox-icalendar][Org Ox-iCalendar]]
...
Use a single set of Org paths so Linux and Windows both work cleanly.
#+begin_src emacs-lisp
