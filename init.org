...
- [[(mark-done-collapse)][Collapse DONE]] items when they are marked as done.
- [[(return-dwim)][Context Aware RET]] key handles check boxes, links, tables, and headings.
- [[(insert-parent-heading)][Insert Parent Heading]] with M-RET.
